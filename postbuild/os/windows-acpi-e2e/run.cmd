...
:battery
set LOG=%ROOT%\battery.log
set FAILURE=ec-test-cli declarative battery test failed
C:\ectest\ec-test-cli.exe --source acpi script run "%ROOT%\battery.test" > "%LOG%" 2>&1
set "COMMAND_EXIT=%ERRORLEVEL%"
if not "%COMMAND_EXIT%"=="0" goto fail
goto pass
